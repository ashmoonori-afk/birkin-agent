---
name: hermes-dogfood
description: "Lightweight Birkin reflection of the Hermes dogfood bundled skill."
version: 0.1.0
platforms: [windows, linux, macos]
metadata: {"birkin": {"alwaysInclude": true}, "hermes": {"category": "dogfood", "tags": ["hermes", "bundled-skill", "reflected-skill"], "upstreamCommit": "bb4703c761ea6687b6399aa2e61e0a08fabd3ca3", "upstreamPath": "skills/dogfood", "upstreamSkill": "dogfood"}}
---

# Hermes Reflection: Dogfood

## Upstream Reference

- Source: `skills/dogfood`
- Upstream skill: `dogfood`
- Upstream description: "Exploratory QA of web apps: find bugs, evidence, reports."

## When to Use

Use this skill when a task asks for the Hermes `dogfood` capability or when a Birkin agent needs to map work to the same bundled-skill intent.
...
- The task maps to the upstream Hermes `dogfood` bundled skill.
