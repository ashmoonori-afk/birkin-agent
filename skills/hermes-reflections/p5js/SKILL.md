---
name: hermes-p5js
description: "Lightweight Birkin reflection of the Hermes p5js bundled skill."
version: 0.1.0
platforms: [windows, linux, macos]
metadata: {"birkin": {"alwaysInclude": true}, "hermes": {"category": "creative", "tags": ["hermes", "bundled-skill", "reflected-skill"], "upstreamCommit": "bb4703c761ea6687b6399aa2e61e0a08fabd3ca3", "upstreamPath": "skills/creative/p5js", "upstreamSkill": "p5js"}}
---

# Hermes Reflection: P5Js

## Upstream Reference

- Source: `skills/creative/p5js`
- Upstream skill: `p5js`
- Upstream description: "p5.js sketches: gen art, shaders, interactive, 3D."

## When to Use

Use this skill when a task asks for the Hermes `p5js` capability or when a Birkin agent needs to map work to the same bundled-skill intent.
...
- The task maps to the upstream Hermes `p5js` bundled skill.
