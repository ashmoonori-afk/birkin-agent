...
description: Lightweight Birkin reflection of the OpenClaw obsidian skill.
version: 0.1.0
platforms: [windows, linux, macos]
metadata: {"openclaw":{"upstreamSkill":"obsidian","alwaysInclude":true,"upstreamCommit":"8d6b5997375890608a1bb46a08c1f5a819443d59"},"hermes":{"tags":["openclaw","reflected-skill"],"category":"openclaw-reflection"}}
---

# OpenClaw Reflection: obsidian

## When to Use

Use this skill when a task asks for the OpenClaw `obsidian` capability or when a Birkin agent needs to route work to a compatible local CLI, integration, or future adapter.
...
- The task maps to the upstream OpenClaw `obsidian` capability.
